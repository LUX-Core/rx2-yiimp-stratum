...
LDFLAGS=-g -ggdb -O2 `mysql_config --libs`
...
SOURCES=stratum.cpp db.cpp coind.cpp coind_aux.cpp coind_template.cpp coind_submit.cpp util.cpp list.cpp \
	...
	user.cpp object.cpp json.cpp base58.cpp satoshi/uint256.cpp satoshi/utilstrencodings.cpp

SOURCES+= rx2.cpp RandomX/src/aes_hash.cpp RandomX/src/argon2_ref.c RandomX/src/argon2_ssse3.c RandomX/src/argon2_avx2.c                 \
